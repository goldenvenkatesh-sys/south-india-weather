...
# ==========================================
# 2. FETCH ECMWF IFS MAX TEMPERATURES
# ==========================================
...
def main():
    ...
    # ==========================================
    # CHANGED: CHOOSE ONE PLOTLY EXPORT METHOD BELOW
    # ==========================================
    
    # METHOD A: Creates a lightweight snippet file that you open in Notepad, 
    # copy entirely, and paste into your blog's HTML editor view.
    print("Writing blog web block file to local space...")
    fig.write_html("south_india_blog_snippet.html", include_plotlyjs='cdn', full_html=False)
    print("Done! Open 'south_india_blog_snippet.html' in Notepad and copy the code to your blog.")
